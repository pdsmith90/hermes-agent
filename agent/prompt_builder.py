...
def _render_skills_index(
    ...
    # Never advertise an affordance this session does not have: the skill_manage lines hand out a
    # self-patching recipe, and emitting them when the tool is absent tells the model to reach for
    # something it cannot legitimately use — on 2026-08-13 a cron job did exactly that.
    _self_mod_lines = ""
