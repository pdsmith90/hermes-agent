...
class PluginContext:
    ...
    def _tool_override_allowed(self, tool_name: str, *, audit: bool = True) -> bool:
        ...
        # audit=False is for the speculative load-time policy probe only (plugins_loader
        # _track_tool_override_policy): the gate result is identical, only the audit line is withheld.
        return plugin_capability_granted(self.plugin_id, "tools.override", config=cfg, audit=audit)
